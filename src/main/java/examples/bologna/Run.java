...
public class Run {
    ...
    public static final String BASEDIR = "output/Bologna/";
    ...
    public static final String DATE = "2015-07-24"; // Friday
    public static final int SCHEDULE_END_TIME_ON_FOLLOWING_DATE = 0*60*60;
